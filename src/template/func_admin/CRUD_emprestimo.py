...
class CRUD_emprestimo:
    ...
    def atualizar_emprestimo():
        ...
        try:
            ...
            with st.form("form_atualizar_emprestimo"):
                st.subheader("Atualizar Dados do Empréstimo")
                ...
                if emprestimo_detalhes and len(emprestimo_detalhes) > 1:
                    ...
                    submitted = st.form_submit_button("Atualizar Empréstimo")
                    ...
                    if submitted:
                        try:
                            ...
                            Views.emprestimo_atualizar(
                                ...
                                emprestimo_detalhes[1],  # Manter a mesma solicitação
                                data_inicio_str, 
                                data_prevista_str,
                                data_devolucao_str
                            )
    ...
    def excluir_emprestimo():
        ...
        try:
            ...
            st.subheader("Selecione o Empréstimo para Excluir")
